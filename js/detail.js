...
$(document).ready(function () {
    ...
    //             }
    //             // .find(".xinfan_item").eq(0).addClass("xq-active")
    ...
    //         var topDes = -(2 - index) * 40 - 160 + "px"
    //         var thisEle = $(".list-detail").eq(index)
    //         thisEle.css("marginTop", topDes)
    //         thisEle.css("display", "block")
    //         thisEle.next(".main-list-panel").find(".xinfan_show").css("marginTop", topDes)
    //         // 选中展示第一个表现
    //         console.log()
    //         thisEle.find(".detail-item").removeClass("xq-active")
    //         thisEle.find(".detail-item").eq(0).addClass("xq-active")
    //         thisEle.next(".main-list-panel").find(".xinfan_show").eq(0).css("display", "block")
    //         thisEle.find(".detail-item").hover(function () {
    //             var itemIndex = $(this).index()
    //             show_container(index, itemIndex)
    //         })
    //     }

    //     function show_container(index, index2) {
    //         var ele = $(".main-list-panel").eq(index).find(".list-main")
    //         ele.css("display", "none")
    //         ele.eq(index2).css("display", "block")
    //     }
